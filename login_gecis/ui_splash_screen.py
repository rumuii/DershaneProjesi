...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>MAVİ DERSHANEM</strong>", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>YÖNETİCİ</strong>: A.F.Z", None))
    # retranslateUi
