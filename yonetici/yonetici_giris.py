from Mavi_Dershanem.login_gecis.deneme3 import SplashScreen
...
"border-radius: 12px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "YÖNETİCİ"))
    ...
    def loginfunc(self):
        ...
        if len(user_name) == 0 or len(password_) == 0:
            ...
            try:
                ...
                cur = conn.cursor()
                cur.execute("SELECT parola FROM tbl_yonetici WHERE email=?", [user_name])
                data = cur.fetchone()[0]
            except TypeError:
